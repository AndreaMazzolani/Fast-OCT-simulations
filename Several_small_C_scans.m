...
str_folder = [DW_signal_folder,'/' ...%dfgag'];%
 'Several_small_Cscans_Nk_35_Nscanx_29_Nscany_29_Nv_1280_Zmin_0_Zmax_40_zf_0_alpha_0_0.1_NL_1_NA_18.mat'];
%    'Several_small_Cscans_Nk_35_Nscanx_29_Nscany_29_Nv_1280_Zmin_0_Zmax_40_zf_0_alpha_0_0.2_NL_1_NA_9.mat'];
%  'Several_small_Cscans_Nk_22_Nscanx_29_Nscany_29_Nv_60_Zmin_0_Zmax_25_zf_0_alpha_0_0.01_NL_1_NA_1000.mat'];
%     'Several_small_Cscans_Nk_35_Nscanx_29_Nscany_29_Nv_1280_Zmin_0_Zmax_40_zf_0_alpha_0_0.15_NL_1_NA_18.mat'];
%   'Several_small_Cscans_Nk_35_Nscanx_29_Nscany_29_Nv_1280_Zmin_0_Zmax_40_zf_0_alpha_0_0.2_NL_1_NA_16.mat'];
%   'Several_small_Cscans_Nk_139_Nscanx_50_Nscany_50_Nv_16000_Zmin_0_Zmax_160_zf_0_alpha_0_0.01_NL_1_NA_1000.mat'];
%   'Several_small_Cscans_Nk_87_Nscanx_48_Nscany_48_Nv_7200_Zmin_0_Zmax_100_zf_0_alpha_0_0.1_NL_1_NA_1000.mat'];
...
%     err_n(akT_sc2,squeeze(akT_sc(:,:,:,end)))
    ...
    str = [DW_signal_folder,'/Several_small_Cscans_Nk_',num2str(Nk),'_Nscanx_',num2str(Nscanx),'_Nscany_',num2str(Nscany),'_Nv_',num2str(Nv),'_Zmin_',num2str(minZ*1e6),'_Zmax_',num2str(maxZ*1e6,3),'_zf_',num2str(z_f*1e6,3),'_alpha_',str_a,'.mat'];
